...
組込み型の型パラメータとして与えたり、`kind()`の引数に指定して利用するものを以下に示す。ただし`numerical_storage_size`は

- `int8`：整数型種別で符号付き8ビット（1バイト）を指す。範囲は$-128$から$127$
- `int16`：同様に、符号付き16ビット（2バイト）を指し、範囲は$-32\:768$から$32\:767$
- `int32`：同様に、符号付き32ビット（4バイト）を指し、範囲は$-2\:147\:483\:648$から$2\:147\:483\:647$
- `int64`：同様に、符号付き64ビット（8バイト）を指し、範囲は$9\:223\:372\:036\:854\:775\:808$から$9\:223\:372\:036\:854\:775\:807$
